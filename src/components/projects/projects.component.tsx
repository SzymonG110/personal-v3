...
const Projects = () => {
	...
	const fetchProjects = async () => {
		...
		if (response.error) return toast.error('Failed to get projects')
	...
	return (
		<div className={styles.projects} id="projects">
			<h2 className={styles.title}>
				Projects I&lsquo;ve been
				<br />
				<span className={styles.green}>involved</span>
			...
			<div className={styles.list}>
				{projects.map((project, i) => (
					<div
						className={i % 2 === 0 ? styles.project : styles.projectReverse}
						key={i}
					>
								...
								<div className={styles.icons}>
									...
									{(project.technologies as string[]).map((t, j) => (
										<span key={`${i} ${j}`}>
											...
											{t === 'JavaScript' && <FontAwesomeIcon icon={faJs} />}
